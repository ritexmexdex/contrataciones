...
<div class="container">
	...
	$checkEmail = "SELECT * FROM usuarios WHERE UsrCod = '$_POST[UsrCod]' ";
	...
	echo "<div class='alert alert-warning mt-4' role='alert'>
					<p>Esta registrado en la base de datos.</p>
	...
	*/
	...
	$query = "INSERT INTO usuarios(UsrCod, UsrFch, UsrPwd, OpcCod, UsrSts, Id_Conf_Correo, UsrTipSerCod, UsrCarTraRea, UsrCarFor001Rea, UsrETETip) VALUES ('$UsrCod', now(), '$UsrPwd', '10', 'A', 14, 4, 0, 9, 1)";
